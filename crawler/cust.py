...
universities = [
    {
        ...
        "body": {
            ...
            "image": {"type": "String", "path": {
                "select": '/html/body/div[1]/div/header/div/div/div/div/div[1]/a[1]/img',
                "next": "select imageUrl"
            }},
            "logo": {"type": "String", "path": {
                "select": '//*[@id="masthead"]/div/div/div/div/div[1]/a[1]/img',
                "next": "select imageUrl"
            }},
            "about": {"type": "String",
                      "path": {
                          "navigate": '/about-capital/',
                          "select": '/html/body/div[1]/div/div/section/div[2]/div/main/article/div/div/div[3]/div/div/div/div[2]/div',
                          "next": 'select text'
                      }
                      },
            ...
            "feeStructure": {
                ...
                "path": {
                    ...
                    "select": '/html/body/div[1]/div/div/section/div[2]/div/main/article/div/div/div[9]/table',
                    "next": "select"
                }
            }
        }
...
if __name__ == "__main__":
    ...
    for university in universities:
        ...
        print()
        fee = extract_table_data(data['fee_structure'])
        feeStructure = []
        ...
        for row in range(1, len(fee)):
            ...
            feeDetails = {
                        fee[0][0]: fee[row][0],  # S No.
                        fee[0][1]: fee[row][1], # Programs
                        fee[0][5]: fee[row][5], # Fall 21
                        fee[0][6]: fee[row][6], # Fall 22
                        fee[0][7]: fee[row][7], # Fall 23
                        fee[0][8]: fee[row][8] # Fall 24
                    }
