...
universities = [
    {
        "baseUrl": "https://iuisl.iqra.edu.pk",
        "body": {
            "name": {"type": "String", "path": {
                "select": 'Iqra University',
                "next": "direct"
            }},
            "image": {"type": "String", "path": {
                "select": '/html/body/div[2]/header/div/div/div/div[1]/div/div/a/img',
            ...
            "about": {"type": "String",
                      "path": {
                          "navigate": '/about-iu/why-choose-iu/',
                          "select": '/html/body/div[2]/main/div/div/div[3]/div',
                          "next": 'select text'
                      }
                      },
            "cover": {"type": "String", "path": {
                "select": '/html/body/div[2]/main/div/div/div[1]/div/div[2]/div/div/img',
                "next": "select imageUrl"
            }},
            "contact": {
...
if __name__ == "__main__":
    ...
    for university in universities:
        ...
        dataToSubmit = {
            "moto": "Leading education institute in Karachi and Islamabad since 1998. Diverse programs, accredited facilities, affordable education.",
            "name": data["name"],
            "image": data["image"],
            "logo": data["logo"],
            "about": data["about"],
